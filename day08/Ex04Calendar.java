...
//
// Calendar의 경우에는
// 1970년 1월1일부터 지금까지 혹은 사용자가 설정한 시간까지를
// 1/1000 초 단위로 계산한다.
// 그것을 기반으로해서 여러가지 값으로 보여주거나
...
public static void main(String[] args) {
    ...
    //대표적으로 사용되는것은
    // Calendar.DATE, Calendar.MONTH등이 있다.
    ...
    // DateFormat의 경우 1/1000초 단위를 우리가 지정한 양식으로 이쁘게 String으로 바꿔주는
    // 역할도 하지만
    // 우리가 입력한 String이 지정한 양식과 일치하면 1/1000초로 바꾸는 역할도 한다.
    
    System.out.println("sdf적용전: "+cal.getTime());
    System.out.println("sdf적용후: "+sdf.format(cal.getTime()));
    ...
    // 만들어진 String을 sdf와 parse를 이용해서 캘린더로 바꿔보자
    // 단 시간이 잘못됐거나 바꿀 수 있는 경우가 존재하기 때문에
    // try catch라는 것을 통해 감싸주어야한다.
