...
public class BoardViewer {
    ...
    public void showBoardMenu() {
        ...
        while (logInUser != null) {
            String message = "1. 새글작성 2. 글 목록 보기 3. 처음 화면으로";
    ...
    private void writeBoard() {
        ...
        b.setWritterDate(Calendar.getInstance());
    ...
    private void printList() {
        ...
        if (boardList.isEmpty()) {
            ...
            System.out.print("상세보기 할 글 번호를 적어주세요(0은 뒤로가기): ");
    ...
    private void printOne(int id) {
        ...
        if (b == null) {
            System.out.println();
            System.out.println("존재하지 않는 글번호입니다. 메뉴로 돌아갑니다.");
            System.out.println();
            ...
            System.out.println("작성일: " + sdf.format(b.getWritterDate().getTime()));
