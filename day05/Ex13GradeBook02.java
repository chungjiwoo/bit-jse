...
public class Ex13GradeBook02 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.printf("%d번 학생번호: ", i + 1);
            idArray[i] = scanner.nextInt();
            System.out.printf("%d번 학생이름: ", i + 1);
            nameArray[i] = ScannerUtil.nextLine(scanner);

            // i번째 학생의 국어점수
            scoreArray[i][0] = ScannerUtil.nextInt(scanner, (i + 1) + "번 학생의 국어", 0, 100);
            // i번째 학생의 영어점수
            scoreArray[i][1] = ScannerUtil.nextInt(scanner, (i + 1) + "번 학생의 영어", 0, 100);
            // i번째 학생의 수학점수
            scoreArray[i][2] = ScannerUtil.nextInt(scanner, (i + 1) + "번 학생의 수학", 0, 100);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.printf("국어:%03d점 국어:%03d점 국어:%03d점\n", korean, english, math);
