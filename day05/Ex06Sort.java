...
public static void main(String[] args) {
    ...
    // i:4
    //intArray[i]:128 
    //intArray[i+1]:ArrayIndexOutofBoundsException 
    ...
    // 도한 for문의 반복할 내용이 끝나면
    // i++이 실행되므로
    // 우리가 만약 i번째와 i+1번째 값을 바꿧으면
    // 다시 0번부터 검사하기 위해서는
    // i를 -1로 초기화해야
    // i++을 통해서 i가 0이 되어서
    // 처음부터 검사할 수 있다.
