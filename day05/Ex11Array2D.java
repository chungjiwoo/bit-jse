...
// "1학년 2반 3번 나와!!!"
// 마찬가지로 우리가 2차원 배열을 기준에서
// 각각의 하나의 데이터타입을 호출할 때에는
// "1학년[2][3]나와!!!"
public class Ex11Array2D {
    public static void main(String[] args) {
        //2차원 배열은 
        //데이터타입[][]배열이름 = new데이터타입[배열의갯수][배열 안의 칸수]
        //으로 선언한다!
        ...
        // 1차원 배열들의 주소값이다!
        // 즉 array[0]은 cac736f라는 메모리주소에 위치한 배열이다.
        // array[1]은 1175e2db라는 메모리주소에 위치한 배열이다.
        // array[2]는 36aa7bc2라는 메모리주소에 위치한 배열이다.
