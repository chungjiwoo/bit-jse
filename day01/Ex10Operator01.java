...
public class Ex10Operator01 {
        public static void main(String[] args) {
            // 산술연산자란, 간단한 4칙연산 + 나머지를 구해주는 연산자이다.
            int myNumber1 = 10;
            int myNumber2 = 15;
           ...
           // 그러므로 결과값은 몫인 0이 나오게 된다.
           System.out.println("myNumber1 % myNumber2: "+(myNumber1 % myNumber2));
           
           // 하지만 산술연산의 경우 한쪽이 실수면
           // 결과값도 실수가 된다.
           ...
           //String이란?
           // 스트링이란 여러개의 문자를 모아둔 문자열을 관리하는 클래스이다.
           // 우리가 스트링 변수를 만들게 되면
           ...
           // 만약 스트링 + 스트링의 경우, 2개의 문자열을 이어붙이겠다 하는 의미가 된다.
           string = "abc";
           ...
           // 단 ++ 혹은 --가 앞에 붙냐 뒤에 붙냐에 따라서 의미가 달라지게 된다.
