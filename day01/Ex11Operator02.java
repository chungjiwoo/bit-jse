...
public class Ex11Operator02 {
       public static void main(String[] args) {
           ...
           //4. 뒤의 값 3을 앞에 공간 number의 현재값에 곱한 후에 그 결과값을 다시 number에 할당해라
           number *= 3;
           System.out.println("number의 현재값 : "+number);
           
           //5. 뒤의 값 4을 앞에 공간 number의 현재값에 나눈 후에 그 결과값을 다시 number에 할당해라
           number /= 4;
           System.out.println("number의 현재값 : "+number);
          
           //6. 뒤의 값 5를 앞에 공간 number의 현재값에 나눈후에 그 나머지를 다시 number에 할당해라
