...
// 이렇게, 크기가 자유로운 배열을 우리가 동적할당한다 하고 한다.

public class Ex06DynamicAlloc {
    public static void main(String[] args) {
        int[] array = new int[0];
        // 현재 array 배열은 크기가 3으로 정적할당 되어있다.
        ...
        // 가장 앞에 지워보기
        System.out.println("0번 삭제전: " + array[0]);
        array = ArrayUtil.removeByIndex(array, 0);
        System.out.println("0번 삭제후: " + array[0]);
        
        //3. 가장 마지막 지워보기
        System.out.println("2번 삭제전: " + array[1]);
        array = ArrayUtil.removeByIndex(array, 1);
        System.out.println("2번 삭제후: " + array[1]);
