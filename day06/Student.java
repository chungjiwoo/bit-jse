...
public class Student {
    ...
    //Student 클래스 생성자
    public Student() {
          //System.out.println("파라미터 없는 생성자 호출");
          id = -1;
          name = new String();
          korean = -1;
          english = -1;
          math = -1;
          //System.out.println("필드초기화 후 종료");
    }
    ...
    //java.lang.Object가 상속한 toSting()오버라이드
    public String toString() {
        return "학생 번호: "+id+",학생이름: "+name+",국어점수: "+korean+",영어점수: "+english+",수학점수: "+math;
    }
    
    //java.lang.Object가 상속한 equals()오버라이드
    public boolean equals(Object o) {
        // 먼저 파라미터로 넘어온 o가
        // 이 클래스(Student) 클래스 개체인지 확인해서
        // 만약 Student 클래스 객체가 맞다고 하면
        // 형 변환을 통해서 Student 객체로 바꿔준다.
        // 그 후 특정 필드들을 비교하여
        // 그 필드들의 값들이 같으면 return true해준다.
        
        //1. o가 Student 클래스 객체인지 확인
        //   이때는 instanceof하는 키워드를 통해서 간단하게 확인 가능하다
        //   instanceof는 널이거나 다른 클래스와 객체일 경우 false가 return 된다.
        
        if(o instanceof Student) {
            // o가 Student 클래스의 객체이므로
            // 이젠 형변환도 가능하다.
            Student s =(Student)o;
            // 이 equals() 메소드를 실행하는 객체와
            //o를 형변환한 s릐 특정 필드(지금은 id와 name)를 비교해서
