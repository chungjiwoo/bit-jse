...
// | : 2개의 정수를 이진법으로 변환하고 같은자리가 한개라도 1이면 1이 나오게 된다.
// ^ : 2개의 정수를 이진법으로 변환하고 같은자리가 다를 때만 1이 나오게 된다.
// ~ : 1개의 정수를 이진법으로 변환하고 1은 0으로 0은 1로 변환한다.
// << : 지전한 숫자만큼 왼쪽으로 비트를 이동한다
// >> : 지정한 숫자만큼 오른쪽으로 비트를 이동하되 부호는 유지한다
// >>> : 지정한 숫자만큼 오른쪽올 비트를 이동하되 무조건  +가 되도록 한다.
public class Ex03Operator05 {
    public static void main(String[] args) {
       ...
       //위의 결과는 우리가 예상하기론 17이 나와야 하지만
        ...
        // 즉
        // 1000 1000앞에 0을 3개 붙이는게 아니라
        // 1111 1111 1111 1111 1111 1111 1000 1000 앞에 0을 3개 붙이게 된다.
        // 그렇게 되면
        // 0001 1111 1111 1111 1111 1111 1111 0001이 되고
        // 맨 뒤에 8비트만 바이트로 변환하면
        // -15가 되어버린다.
