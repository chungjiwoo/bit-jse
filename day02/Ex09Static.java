package day02;
// 자바에는 크게 3가지 메모리 영역이 있ㄷ.
// 1. 스택 : 변수가 선언되는 공간
// 2. 힙 : 참조형 변수의 실제 값이 들어있는공간
// 3. 메소드 : 실행할 코드가 저장되는 공간
//
// 메소드 영역에 우리가 코드를 저장시킬려면
// 반드시 해당 코드가 static 이라는 키워드가 붙어 있어야한다.
...
// 왜냐하면 static을 쓰겠다는 것은 객체 선언을 하지않고 메소드만 호출한다는 의미인데
// 그렇게 된다면 2세대언어인 절차지향적 언어와 차이가 없기 때문이다.
// 따라서 static을 사용하는건 최대란 피하자
