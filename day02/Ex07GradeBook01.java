...
public class Ex07GradeBook01 {
    ...
    public static void main(String[]args) {
        ...
        // 매직 넘버 (마술의 숫자)
        // 매직넘버란 소스코드 중간에 갑자기 튀어나오는
        // 정수나 실수 혹은 문자열을 매직 넘버라 부른다.
        // 이러한 매직넘버는 간단한 프로그램을 짤 때에는 유용하지만
        ...
        // 을 소프트코딩하면 어떻게 될까?
        // 3을 가지고 있는 상수를 만들고
        // double average = sum / (double)과목수 요런식으로 만들어 주어야한다.
