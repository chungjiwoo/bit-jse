...
public class Ex06Scanner {
    public static void main(String[]args) {
          ...
          // 1. 정수입력받기
          //     정수를 입력 받을때에는 scanner와 nextInt()메소드를 호출해주면 된다.
          ...
          // 2. 실수 입력 받기
          //    실수를 입력 받을 때에는 scanner와 nextDouble() 메소드를 호출해주면 된다.
          ...
          //3. 스트링 입력 받기
          //   스트링 입력 받을때에는 scanner와 nextLine() 메소드를 호출해주면 된다.
          //   스트링 입력 시에는 한가지 주의할 점이 있는데
          //   nextInt(),nextDouble()등의 숫자를 입력하는 메소드 이후에는
          //   netxLine()을 곧장 사용하면 안된다
            ...
            // 123\n라고 입력하면,
            // netxInt()가 123만 가져가고 \n은 버퍼메모리에 남겨둔다
            // 하지만 netxLine()의 경우 모든 문자를 다 가져올수 있는데
            // 버퍼메모리에 남아있던 \n을 보고 " 아 사용자가 입력을 끝냈구나!"라고
            // 착각하게 된다.
            // 이것이 scanner의 netxLine()버그이다.
            
            // 해당 버그를 해결하기 위해서는
            // nextInt(),nextDouble() 사용하고
            // netxLine()을 사용하기전에 netxLine()을 한번 더 실행해주면 된다.
