...
public class Ex05Printf {
    public static void main(String[] args) {
        ...
        //   10~15는 A~F로 표시한다.
          ...
          //D. 실수를 소수점은 2번째자리까지 출력해라
          System.out.printf("D. %.2f\n", myDouble);
          //E. 실수를 오른쪽 정렬 12자리로 표시하고 소수점은 3번째자리까지 출력해라
          System.out.printf("E. %12.3f\n", myDouble);
          //F. 실수를 왼쪽 정렬 10자리로 표시하고 소수점은 1번째자리까지 출력해라
          System.out.printf("F. %-10.1f(끝)\n", myDouble);
          //G. 실수를 오른쪽 정렬 12자리로 표시하고 소수점은 2번째자리까지 출력하고
          //   왼쪽 빈자리를 0으로 채워라
          ...
          //System.out.printf("%d\n", 123.45);
          //4. 만약 %문자가 나온 횟수보다 뒤에 값들이 더 많은 경우는 에러가 나진 않지만
