package day02;
// 제어문
// 제어문이란 특정 코드가 실행될지 혹은 반복할지를 결정하는 특수한 코드이다
// 제어문에는 조건문과 반복문이 있다.
...
// 특정 변수와 유효범위는 해당 변수가 선언되고 그 변수가 선언된 총괄호가 끝날때까지이다.
// 해당 유효범위 안에서는 그 변수와 똑같은 이름의 변수는 선언할 수 없다.
// 유효범위가 끝나면 해당 변수는 사라진걸로 취급되서 호출될수도 없다.
...
public class Ex10If {
    ...
    public static void main(String[]args) {
        ...
        if(number < 0) {
            ...
            System.out.println("number는 10이하입니다.");
        }
