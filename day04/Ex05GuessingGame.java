...
// 컴퓨터가 임의로 만든 숫자(=난수)를
// 사용자가 알아맞추는 게임
// 만약 사용자가 입력한 숫자가 컴퓨터 난수보가 크면
// "Down"이라고 출력되고
// 작으면"Up"이라고 출력된다
// 또한 사용자의 최고기록을 보관을 해서
// 만약 메뉴에서 최고기록 보기를 하면
// 해당 최고 기록을 볼수 있게 된다.
// 플레이가 끝날 때, 최고기록이 바뀌는 경우도 반영한다.
 ...
 public static void main(String[]args) {
     ...
     while(true) {
         ...
         if(userChoice == 1) {
             ...
             // computerNumber에는 1~100사이의 숫자가 들어가있다.
             // 그렇다면 int userNumber를 0으로 초기화하고
             // while 조건식을 computerNumber != userNumber라고 하면
             // 무조건 1번은 실행되지 않을까?
             ...
             // if-else 구조를 사용해서
             // bestScore가 0이면,
             //"아직 플레이 한 기록이 없습니다"라는 메세지를 출력하고
             // 그 외에는 "현재 최고기록은 ##회 입니다!"리고 출력되게 만들어주자
             if(bestScore == 0) {
