...
public static void main(String[] args) {
    ...
    // <>에는 클래스만 들어갈 수 있다!
    // 그렇다면... 기본형 데이터타입은 ArrayList로 관리할 수 있는가?
    // 없다!
    ...
    // 2.ArrayList 메소드 보기
    //  A.해당 리스트가 몇개의 요소가 있는지 확일할 때에는 size()
   ...
   // D.만약 리스트에서 특정 index에 요소를 삭제하고 싶다면
   //   remove(index)
    ...
    //    가장 앞에 나오는 1개만 제거 된다.
    //    만약에 해당 리스트에 존재하지 않는(즉 equals()가 true가 나오는 객체가 하나도 없을경우)
